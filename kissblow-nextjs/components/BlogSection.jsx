...
const BlogSection = () => {
  ...
  // Get featured articles (first 3) with safety check
  const featuredPosts = Array.isArray(blogPosts) ? blogPosts.slice(0, 3) : []

  // Early return if no posts available
    ...
    <div className="w-full">
      ...
      <div className="text-center">
        <Link 
          ...
          aria-label="View all escort service guides and safety tips"
        >
