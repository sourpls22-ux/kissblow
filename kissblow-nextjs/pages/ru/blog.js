...
const Blog = ({ translations, lastUpdated: staticLastUpdated }) => {
  ...
  const seoData = {
    ...
    url: 'https://kissblow.me/ru/blog',
    canonical: 'https://kissblow.me/ru/blog',
    alternate: { en: 'https://kissblow.me/blog' }
  }

  const breadcrumbs = [
    { name: t('breadcrumbs.home'), path: '/' },
    { name: t('blog.title'), path: '/ru/blog' }
  ]
      ...
      <div className="min-h-screen theme-bg py-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm theme-text-secondary mt-4">Последнее обновление: {lastUpdated}</p>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-onlyfans-accent/10 to-onlyfans-dark/10 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-theme-text-secondary">Категории</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-onlyfans-accent mb-2">
                  5+
                </div>
                <div className="text-theme-text-secondary">Руководства по безопасности</div>
              </div>
            </div>
          </div>
        </div>
