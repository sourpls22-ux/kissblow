...
const Search = ({ translations }) => {
  ...
  const seoData = {
    ...
    url: 'https://kissblow.me/ru/search',
    canonical: 'https://kissblow.me/ru/search',
    alternate: { en: 'https://kissblow.me/search' }
  }
          ...
          <div className="w-full max-w-none sm:max-w-md p-2 sm:p-8 theme-surface rounded-xl shadow-lg border theme-border">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-[10px] sm:text-xs text-center text-gray-500">
                ...
                <Link href="/ru/terms" className="text-[#00bfff] hover:underline">
                  {t('search.termsOfUse')}
                </Link>
              </p>
            </div>
