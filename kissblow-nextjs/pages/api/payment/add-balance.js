          ...
          db.run(
            ...
            function(err) {
              if (err) {
                ...
                const paymentUrl = `https://atlos.io/pay?merchantId=${process.env.ATLOS_MERCHANT_ID}&orderId=${orderId}&orderAmount=${amount}&orderCurrency=USD&onSuccess=${encodeURIComponent(paymentData.onSuccess)}&onCanceled=${encodeURIComponent(paymentData.onCanceled)}`
