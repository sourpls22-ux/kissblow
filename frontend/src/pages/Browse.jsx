  ...
  return (
    ...
    <div className="min-h-screen theme-bg py-8 no-flicker">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 smooth-transition">
        ...
        {showFilters && (
          <div 
            className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 p-4 pt-20 pb-12 sm:pb-4"
          ...
          >
            <div 
              className="theme-surface rounded-lg p-4 w-full max-w-2xl max-h-[calc(100vh-16rem)] sm:max-h-[calc(100vh-12rem)] overflow-y-auto border theme-border modal-content"
              style={{ 
                marginBottom: 'env(safe-area-inset-bottom, 2rem)',
