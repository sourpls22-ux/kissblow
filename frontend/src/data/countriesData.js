// Данные стран с городами для SEO секции (все страны доступные при создании анкеты)
export const countriesData = [
  ...
  },
  {
    name: 'UK',
    cities: [
      'London UK', 'Birmingham', 'Manchester', 'Glasgow', 'Liverpool', 'Leeds', 
      'Sheffield', 'Edinburgh', 'Bristol', 'Leicester', 'Coventry', 'Cardiff', 
      'Belfast', 'Nottingham', 'Hull', 'Newcastle UK', 'Stoke-on-Trent', 
  ...
  },
  {
    ...
    cities: [
      ...
      'Gijón', 'Hospitalet', 'Vitoria', 'A Coruña', 'Granada', 'Elche'
    ]
  },
  {
    name: 'Italy',
  ...
  },
  {
    ...
    cities: [
      ...
      'Perm', 'Voronezh', 'Volgograd', 'Krasnodar', 'Saratov', 'Tyumen', 'Tolyatti', 'Izhevsk'
    ]
  },
  {
    name: 'Ukraine',
    cities: [
      ...
      'Cherkasy', 'Zhytomyr', 'Sumy', 'Khmelnytskyi', 'Rivne'
    ]
  },
  {
    name: 'Poland',
  ...
  },
  {
    ...
    cities: [
      ...
      'Leonding', 'Klosterneuburg', 'Baden', 'Wolfsberg', 'Leoben', 'Krems'
    ]
  },
  {
    name: 'Sweden',
    cities: [
      ...
      'Södertälje', 'Karlstad', 'Eskilstuna', 'Sundsvall', 'Halmstad', 'Växjö'
    ]
  },
  {
    name: 'Norway',
    cities: [
      ...
      'Tromsø', 'Drammen', 'Skien', 'Ålesund', 'Tønsberg', 'Moss', 'Haugesund', 'Sandefjord', 
      'Arendal', 'Sandnes', 'Bodø', 'Hamar'
    ]
  },
  {
    name: 'Denmark',
    cities: [
      ...
      'Viborg', 'Køge', 'Holstebro', 'Taastrup', 'Slagelse', 'Hillerød'
    ]
  },
  {
    name: 'Finland',
  ...
  },
  {
    ...
    cities: [
      ...
      'Newcastle AU', 'Canberra', 'Sunshine Coast', 'Wollongong', 'Hobart', 'Geelong', 
      'Townsville', 'Cairns', 'Darwin', 'Toowoomba', 'Ballarat', 'Bendigo', 'Albury', 'Launceston'
    ]
  },
  {
    name: 'Japan',
    cities: [
      ...
      'Hamamatsu', 'Okayama', 'Sagamihara', 'Kumamoto'
    ]
  },
  {
    name: 'South Korea',
    cities: [
      ...
      'Changwon', 'Goyang', 'Yongin', 'Bucheon', 'Ansan', 'Anyang', 'Namyangju', 
      'Hwaseong', 'Cheongju', 'Jeonju', 'Cheonan', 'Gimhae'
    ]
  },
  {
    name: 'China',
    cities: [
      ...
      'Chengdu', 'Nanjing', 'Xi\'an', 'Hangzhou', 'Foshan', 'Shenyang', 'Harbin', 
      'Qingdao', 'Dalian', 'Jinan', 'Zhengzhou', 'Changsha', 'Kunming'
    ]
  },
  {
    name: 'India',
  ...
  },
  {
    ...
    cities: [
      ...
      'Acapulco', 'Culiacán', 'Saltillo', 'Hermosillo', 'Morelia', 'Reynosa', 'Tampico'
    ]
  },
  {
    name: 'Argentina',
    cities: [
      ...
      'Corrientes', 'Posadas', 'San Salvador de Jujuy', 'Bahía Blanca', 'Paraná', 'Formosa', 'San Luis'
    ]
  },
  {
    name: 'Chile',
    cities: [
      ...
      'Valdivia', 'Osorno', 'Quilpué', 'Curicó', 'Villa Alemana', 'Coronel', 'San Antonio CL'
    ]
  },
  {
    name: 'Colombia',
    cities: [
      ...
      'Armenia', 'Valledupar', 'Montería', 'Sincelejo', 'Popayán', 'Buenaventura'
    ]
  },
  {
    name: 'Peru',
    cities: [
      ...
      'Huancayo', 'Tacna', 'Ica', 'Juliaca', 'Sullana', 'Chincha Alta', 'Huaraz', 
      'Cajamarca', 'Puno', 'Tumbes', 'Talara', 'Huaral'
    ]
  },
  {
    name: 'Venezuela',
    cities: [
      'Caracas', 'Maracaibo', 'Valencia VE', 'Barquisimeto', 'Maracay', 'Ciudad Guayana', 
      'San Cristóbal', 'Maturín', 'Ciudad Bolívar', 'Cumana', 'Cabimas', 'Mérida', 
      'Puerto La Cruz', 'Barinas', 'Los Teques', 'Punto Fijo', 'Guarenas', 'Acarigua', 'Turmero', 'Carora'
    ]
  },
  {
    name: 'Egypt',
    cities: [
      ...
      'Aswan', 'Damietta', 'Minya', 'Beni Suef', 'Hurghada', 'Qena'
    ]
  },
  {
    name: 'South Africa',
    cities: [
      ...
      'East London', 'Pietermaritzburg', 'Nelspruit', 'Kimberley', 'Polokwane', 'Rustenburg', 
      'Welkom', 'Potchefstroom', 'Klerksdorp', 'Middelburg', 'Vereeniging', 'Soweto', 'Tembisa', 'Umlazi'
    ]
  },
  {
    name: 'Nigeria',
    cities: [
      'Lagos', 'Kano', 'Ibadan', 'Benin City', 'Port Harcourt', 'Jos', 'Ilorin', 'Abuja', 
      'Kaduna', 'Maiduguri', 'Zaria', 'Aba', 'Ilesa', 'Onitsha', 'Iwo', 'Ado-Ekiti', 
      'Uyo', 'Owerri', 'Abeokuta', 'Sokoto'
    ]
  },
  {
    name: 'Kenya',
    cities: [
      'Nairobi', 'Mombasa', 'Kisumu', 'Nakuru', 'Eldoret', 'Malindi', 'Kitale', 'Garissa', 
      'Kakamega', 'Nyeri', 'Meru', 'Machakos', 'Thika', 'Embu', 'Nanyuki', 'Kericho', 
      'Bungoma', 'Busia', 'Homa Bay', 'Migori'
    ]
  },
  {
    name: 'Morocco',
  ...
  },
  {
    ...
    cities: [
      ...
      'Beer Sheva', 'Holon', 'Bnei Brak', 'Ramat Gan', 'Bat Yam', 'Ashkelon', 'Rehovot', 
      'Herzliya', 'Kfar Saba', 'Hadera', 'Raanana', 'Modiin', 'Nazareth'
    ]
  },
  {
    name: 'UAE',
  ...
  },
  {
    ...
    cities: [
      ...
      'Buraidah', 'Tabuk', 'Khamis Mushait', 'Hail', 'Najran', 'Al Bahah', 'Yanbu', 
      'Abha', 'Sakaka', 'Jizan', 'Al Qunfudhah', 'Arar'
    ]
  },
  {
    name: 'Thailand',
    cities: [
      ...
      'Pak Kret', 'Khon Kaen', 'Ubon Ratchathani', 'Nakhon Si Thammarat', 'Nakhon Sawan', 
      'Phitsanulok', 'Chonburi', 'Nakhon Pathom', 'Lampang', 'Ratchaburi', 'Surat Thani', 
      'Krabi', 'Phuket', 'Pattaya'
    ]
  },
  {
    name: 'Vietnam',
    cities: [
      ...
      'Nha Trang', 'Buon Ma Thuot', 'Qui Nhon', 'Vung Tau', 'Thai Nguyen', 'Thanh Hoa', 
      'Nam Dinh', 'Vinh', 'Long Xuyen', 'Rach Gia', 'My Tho', 'Ca Mau', 'Bac Lieu'
    ]
  },
  {
    name: 'Philippines',
    cities: [
      'Manila', 'Quezon City', 'Caloocan', 'Davao', 'Cebu City', 'Zamboanga', 'Antipolo', 
      'Pasig', 'Taguig', 'Valenzuela', 'Parañaque', 'Las Piñas', 'Makati', 'Bacolod', 
      'General Santos', 'Marikina', 'Muntinlupa', 'Calamba', 'San Jose del Monte', 'Cagayan de Oro'
    ]
  },
  {
    name: 'Indonesia',
    cities: [
      'Jakarta', 'Surabaya', 'Bandung', 'Medan', 'Semarang', 'Palembang', 'Tangerang', 
      'Makassar', 'Depok', 'Bekasi', 'Padang', 'Malang', 'Pekanbaru', 'Tegal', 'Bogor', 
      'Cirebon', 'Surakarta', 'Banjarmasin', 'Pontianak', 'Manado'
    ]
  },
  {
    name: 'Malaysia',
    cities: [
      'Kuala Lumpur', 'George Town', 'Ipoh', 'Shah Alam', 'Petaling Jaya', 'Klang', 
      'Johor Bahru', 'Subang Jaya', 'Kuching', 'Kota Kinabalu', 'Kajang', 'Ampang', 
      'Kuala Terengganu', 'Miri', 'Taiping', 'Kota Bharu', 'Kulim', 'Sandakan', 'Seremban', 'Alor Setar'
    ]
  },
  {
    name: 'Singapore',
  ...
  },
  {
    ...
    cities: [
      ...
      'Keelung', 'Chiayi', 'Changhua', 'Yunlin', 'Pingtung', 'Taitung', 'Hualien', 
      'Nantou', 'Yilan', 'Kinmen', 'Penghu', 'Matsu', 'Lienchiang'
    ]
  }
]